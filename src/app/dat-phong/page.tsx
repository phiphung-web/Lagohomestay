...
export const metadata: Metadata = { title: "Chọn căn và đặt chỗ", description: "Kiểm tra lịch trống, so sánh các căn phù hợp và gửi yêu cầu giữ chỗ tại Lago Homestay." };
