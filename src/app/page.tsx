...
export default function HomePage() {
  ...
  return <SiteShell>
    ...
    <section id="chon-can" className="section-pad overflow-hidden bg-lago-cream">
      <div className="container-lago">
        ...
        <div className="mt-11"><StayExplorer stays={stays} compact /></div>
      </div>
    </section>

    <section className="relative overflow-hidden bg-lago-ink py-20 text-white sm:py-28">
