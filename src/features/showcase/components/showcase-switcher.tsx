...
export function ShowcaseSwitcher({ current, locale = "vi" }: { current: ShowcaseTemplateSlug; locale?: ShowcaseLocale }) {
  ...
  const pageLabel = getShowcasePageLabel(pathname, locale);
