...
export function ShowcaseSwitcher({ current }: { current: ShowcaseTemplateSlug }) {
  return <aside className="fixed bottom-4 left-1/2 z-[70] w-[calc(100%-24px)] max-w-2xl -translate-x-1/2 rounded-[22px] border border-white/20 bg-[#0b1c17]/92 p-2 text-white shadow-2xl backdrop-blur-xl sm:bottom-5 sm:flex sm:items-center sm:gap-2 sm:rounded-full">
