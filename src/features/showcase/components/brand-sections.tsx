...
const quote =
  "Một kỳ nghỉ tốt không cần quá nhiều thứ để làm. Chỉ cần đúng người, đúng không gian và đủ thời gian.";
...
const missionStatement = {
  ...
  en: {
    kicker: "Our Mission",
    quote:
      "Preserving untouched beauty through every pane of glass — the wellspring of genuine connections",
            ...
            >
              <div>
                ...
                <div className="mt-5 space-y-4 text-sm leading-relaxed text-[#16311c]/75">
                  ...
                  {item.intro && <p className="font-medium text-[#16311c]/90">{item.intro}</p>}
                  ...
                  {item.bulletPoints && (
                    <ul className="space-y-2.5 pl-1">
                      {item.bulletPoints.map((bullet, bIdx) => (
                        <li
                          key={bIdx}
                          className="flex items-center gap-2.5 font-medium text-[#16311c]/85"
                        >
...
export function ContactChannels({ mood, locale = "vi" }: { mood: Mood; locale?: ShowcaseLocale }) {
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="text-[.55rem] font-bold text-[#80613f] group-hover:text-[#c7a882]">
                      0{index + 1}
                    </span>
                    {IconComponent ? (
                  ...
                  <p className="mt-8 text-[.55rem] font-bold uppercase tracking-[.18em] opacity-75">
                    {item.label}
                  </p>
                  <p className="mt-1.5 break-words font-sans text-sm font-bold leading-snug">
                    {item.value}
                  </p>
                </div>
