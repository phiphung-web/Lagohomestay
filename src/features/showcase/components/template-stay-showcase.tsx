...
export function TemplateStayHero({ mood, basePath, stay, locale = "vi" }: { mood: Mood; basePath: string; stay: Stay; locale?: ShowcaseLocale }) {
  ...
  if (mood === "editorial") return <section className="relative min-h-[84svh] overflow-hidden bg-[#10251d] text-white lg:min-h-[92svh]">
    ...
    <div className="relative z-10 mx-auto flex min-h-[84svh] w-[min(1480px,calc(100%-40px))] flex-col justify-between pb-12 pt-28 sm:pb-16 lg:min-h-[92svh]">
