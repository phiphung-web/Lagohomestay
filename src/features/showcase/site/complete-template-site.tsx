...
function SocialContactIcons() {
  return <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4" aria-label="Các kênh liên hệ">
    <a href="https://facebook.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Facebook LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-[#16311c]/60 bg-white/70 text-[#16311c] shadow-sm transition hover:scale-105 hover:border-[#16311c] hover:bg-[#16311c] hover:text-white">
    ...
    <a href="https://m.me/lagohomestay" target="_blank" rel="noreferrer" aria-label="Messenger LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-[#16311c]/60 bg-white/70 text-[#16311c] shadow-sm transition hover:scale-105 hover:border-[#16311c] hover:bg-[#16311c] hover:text-white">
    ...
    <a href="https://instagram.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Instagram LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-[#16311c]/60 bg-white/70 text-[#16311c] shadow-sm transition hover:scale-105 hover:border-[#80613f] hover:bg-[#80613f] hover:text-white">
      <Instagram className="h-5 w-5" />
    </a>
    <a href={publicContact.zaloHref} target="_blank" rel="noreferrer" aria-label="Zalo LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-[#16311c]/60 bg-white/70 text-[#16311c] shadow-sm transition hover:scale-105 hover:border-[#16311c] hover:bg-[#16311c] hover:text-white">
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
        <mask id="zalo-mask-template-footer">
    ...
    <a href="https://tiktok.com/@lagohomestay" target="_blank" rel="noreferrer" aria-label="TikTok LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-[#16311c]/60 bg-white/70 text-[#16311c] shadow-sm transition hover:scale-105 hover:border-[#16311c] hover:bg-[#16311c] hover:text-white">
    ...
    <a href={publicContact.phoneHref} aria-label="Hotline LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-[#16311c]/60 bg-white/70 text-[#16311c] shadow-sm transition hover:scale-105 hover:border-[#16311c] hover:bg-[#16311c] hover:text-white">
...
export function TemplateFooter({ config, locale = "vi", storyMode = false, homeMode = false }: { config: CompleteTemplateConfig; locale?: ShowcaseLocale; storyMode?: boolean; homeMode?: boolean }) {
  if (homeMode) return <footer className="border-t border-[#16311c]/25 bg-[#eae1d2] pb-28 pt-14 text-[#16311c] sm:pb-32">
    <div className="mx-auto flex w-[min(1420px,calc(100%-40px))] flex-col items-center text-center">
      ...
      {/* Thông tin 1 hàng căn giữa */}
      <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-[15px] font-medium text-[#16311c]/90 sm:gap-x-8">
      ...
      <div className="mt-8 flex flex-col items-center gap-3">
        <p className="eyebrow text-xs font-bold uppercase tracking-[.18em] opacity-65">{locale === "en" ? "Connect" : "Kết nối"}</p>
        <SocialContactIcons />
      </div>
    </div>
  ...
  return <footer className={`border-t border-current/25 pb-28 pt-14 sm:pb-32 ${config.mood === "organic" ? "bg-[#e7ded1]" : config.mood === "cinematic" ? "bg-[#0b190f]" : "bg-[#eae1d2]"}`}>
    <div className="mx-auto flex w-[min(1420px,calc(100%-40px))] flex-col items-center text-center">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-[15px] font-medium opacity-90 sm:gap-x-8">
        <Link href={scoped(config.basePath, "di-chuyen")} className="transition hover:underline">{locale === "en" ? "Getting here" : "Hướng dẫn di chuyển"}</Link>
        <Link href={scoped(config.basePath, "dieu-khoan")} className="transition hover:underline">{locale === "en" ? "Terms" : "Điều khoản"}</Link>
