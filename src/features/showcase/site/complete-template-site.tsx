...
function SocialContactIcons() {
  return <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:justify-start" aria-label="Các kênh liên hệ">
    ...
    <a href="https://m.me/lagohomestay" target="_blank" rel="noreferrer" aria-label="Messenger LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-md border border-current/40 transition hover:scale-105 hover:border-[#80613f] hover:bg-[#80613f] hover:text-white">
    ...
    <a href="https://instagram.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Instagram LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-md border border-current/40 transition hover:scale-105 hover:border-[#80613f] hover:bg-[#80613f] hover:text-white">
      <Instagram className="h-5 w-5" />
    </a>
    <a href={publicContact.zaloHref} target="_blank" rel="noreferrer" aria-label="Zalo LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-md border border-current/40 transition hover:scale-105 hover:border-[#80613f] hover:bg-[#80613f] hover:text-white">
    ...
    <a href="https://tiktok.com/@lagohomestay" target="_blank" rel="noreferrer" aria-label="TikTok LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-md border border-current/40 transition hover:scale-105 hover:border-[#80613f] hover:bg-[#80613f] hover:text-white">
    ...
    <a href={publicContact.phoneHref} aria-label="Hotline LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-md border border-current/40 transition hover:scale-105 hover:border-[#80613f] hover:bg-[#80613f] hover:text-white">
