...
export const stays: Stay[] = [
  {
    ...
    longDescription: "Lago House được tạo nên cho những cuộc hội ngộ. Phòng khách lớn nối liền gian bếp, sân BBQ cho bữa tối dài và ba phòng ngủ yên tĩnh để mỗi người đều có một khoảng nghỉ thật sự.",
