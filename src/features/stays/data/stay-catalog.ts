...
// Fallback photos for entries without LAKA assets. Local photos are mapped in
// laka-images.ts; keep the concept label on surfaces using these remote images.
export const conceptImages = {
  ...
  forest:
    "https://images.unsplash.com/photo-1775547081703-1472317fe554?auto=format&fit=crop&w=1800&q=88",
  cloud:
    "https://images.unsplash.com/photo-1601918774946-25832a4be0d6?auto=format&fit=crop&w=1800&q=88",
  ...
  breakfast:
    "https://images.unsplash.com/photo-1533777857889-4be7c70b33f7?auto=format&fit=crop&w=1800&q=86",
  table:
    "https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=1800&q=86",
};
...
export const stayZones: StayZone[] = [
  {
    ...
    description:
      "Những căn nằm sát hoặc hướng thẳng ra hồ, dành cho buổi sáng chậm, khoảnh khắc riêng tư và các cuộc sum vầy.",
    descriptionEn:
      "Homes beside or directly facing the lake, made for slow mornings, private pauses and time together.",
  ...
  },
  {
    ...
    description:
      "Các căn cabin và bungalow nép mình dưới bóng rừng xanh, tạo nên một không gian nghỉ ngơi thật gần gũi với thiên nhiên.",
    descriptionEn:
      "Cabins and bungalows nestled beneath pine trees, creating a restful space close to nature.",
  ...
  },
  {
    ...
    description:
      "Căn villa biệt lập trên đỉnh đồi, bao quát trọn vẹn thung lũng, mặt hồ và những khoảng trời của riêng bạn.",
    descriptionEn:
      "A secluded hilltop villa with panoramic views of valley, lake and boundless skies.",
...
export const stays: Stay[] = [
  ...
  // -------------------------------------------------------------
  {
    ...
    description:
      "Guest House nằm ngay bên hồ lớn, nơi mỗi sớm mai mở mắt là thấy đồi núi và rừng thông trải dài trước mặt. Với 5 giường vừa cho tối đa 10 người, đây là chốn để cả nhóm quây quần, cùng ngắm hồ, nghe gió qua rừng và cất giữ những khoảnh khắc thật đẹp bên nhau.",
    longDescription:
      "Guest House nằm ngay bên hồ lớn, nơi mỗi sớm mai mở mắt là thấy đồi núi và rừng thông trải dài trước mặt. Với 5 giường vừa cho tối đa 10 người, đây là chốn để cả nhóm quây quần, cùng ngắm hồ, nghe gió qua rừng và cất giữ những khoảnh khắc thật đẹp bên nhau.",
    image: conceptImages.hero,
  ...
  },
  {
    ...
    description:
      "Một mặt kính lớn mở trọn thiên nhiên trước mắt, như màn hình riêng dành cho những khoảng trời bất tận. Ở đây, căn phòng không chỉ là nơi nghỉ, mà là một khoảng riêng thênh thang để ngắm, để thở và để tận hưởng bình yên theo cách của mình.",
    longDescription:
      "Một mặt kính lớn mở trọn thiên nhiên trước mắt, như màn hình riêng dành cho những khoảng trời bất tận. Ở đây, căn phòng không chỉ là nơi nghỉ, mà là một khoảng riêng thênh thang để ngắm, để thở và để tận hưởng bình yên theo cách của mình.",
    image: lakaImages.stays.forestLakeSuite.cover,
    gallery: [...lakaImages.stays.forestLakeSuite.gallery],
    maxGuests: 4,
    baseGuests: 2,
    bedrooms: 1,
    beds: 1,
    ...
    highlights: [
      "6 căn Forest Lake Suite",
      "Mặt kính lớn ôm trọn cảnh sắc",
  ...
  },
  {
    ...
    description:
      "Cabin Vô Cực là góc ngắm “đỉnh” nhất tại LaKa, với hai mặt kính lớn mở ra tầm nhìn 180 độ ôm trọn mặt hồ, đồi núi và mây trời. Ranh giới giữa căn phòng và thiên nhiên gần như tan biến, để mỗi khoảnh khắc nghỉ ngơi đều có cảm giác rộng mở, thênh thang và thật gần với cảnh sắc bên ngoài.",
    longDescription:
      "Cabin Vô Cực là góc ngắm “đỉnh” nhất tại LaKa, với hai mặt kính lớn mở ra tầm nhìn 180 độ ôm trọn mặt hồ, đồi núi và mây trời. Ranh giới giữa căn phòng và thiên nhiên gần như tan biến, để mỗi khoảnh khắc nghỉ ngơi đều có cảm giác rộng mở, thênh thang và thật gần với cảnh sắc bên ngoài.",
    image: lakaImages.stays.bathtubSuite.cover,
    gallery: [...lakaImages.stays.bathtubSuite.gallery],
    maxGuests: 4,
    baseGuests: 2,
    bedrooms: 1,
    beds: 1,
  ...
  },
  {
    ...
    description:
      "Cabin An Trú mở ra thiên nhiên qua một ô cửa kính vừa như khung hình, vừa như khoảng lặng dành riêng cho mình. Một góc nhìn đủ để thu trọn sắc xanh bên ngoài, và một không gian đủ yên tĩnh để chậm lại, nghỉ ngơi và tận hưởng sự riêng tư.",
    longDescription:
      "Cabin An Trú mở ra thiên nhiên qua một ô cửa kính vừa như khung hình, vừa như khoảng lặng dành riêng cho mình. Một góc nhìn đủ để thu trọn sắc xanh bên ngoài, và một không gian đủ yên tĩnh để chậm lại, nghỉ ngơi và tận hưởng sự riêng tư.",
    image: lakaImages.stays.lakeSuite.cover,
    gallery: [...lakaImages.stays.lakeSuite.gallery],
    maxGuests: 2,
    baseGuests: 2,
    bedrooms: 1,
    beds: 1,
  ...
  // -------------------------------------------------------------
  {
    ...
    description:
      "Căn bungalow ấm áp với nội thất gỗ sáng màu và gác xép xinh xắn, vừa vặn cho nhóm 5–7 người. Nằm ngay đối diện hồ lớn, nơi mở mắt ra là thấy đồi núi và rừng thông trải dài — đủ gần để chạm thiên nhiên, đủ rộng để cả nhóm cùng chill và tận hưởng những ngày thật thong thả.",
    longDescription:
      "Căn bungalow ấm áp với nội thất gỗ sáng màu và gác xép xinh xắn, vừa vặn cho nhóm 5–7 người. Nằm ngay đối diện hồ lớn, nơi mở mắt ra là thấy đồi núi và rừng thông trải dài — đủ gần để chạm thiên nhiên, đủ rộng để cả nhóm cùng chill và tận hưởng những ngày thật thong thả.",
    image: lakaImages.stays.bungalow.cover,
    gallery: [...lakaImages.stays.bungalow.gallery],
    maxGuests: 7,
    baseGuests: 5,
    bedrooms: 2,
    beds: 2,
  ...
  },
  {
    ...
    description:
      "Cabin cộng đồng với 7 giường tầng dành cho tối đa 14 người, nép mình giữa rừng thông đại ngàn. Bốn ô cửa kính mở ra những mảng xanh khác nhau, để cả nhóm vừa có một không gian thật gần nhau, vừa luôn cảm nhận được thiên nhiên đang ở ngay bên cạnh.",
    longDescription:
      "Cabin cộng đồng với 7 giường tầng dành cho tối đa 14 người, nép mình giữa rừng thông đại ngàn. Bốn ô cửa kính mở ra những mảng xanh khác nhau, để cả nhóm vừa có một không gian thật gần nhau, vừa luôn cảm nhận được thiên nhiên đang ở ngay bên cạnh.",
  ...
  // -------------------------------------------------------------
  {
    ...
    longDescription:
      "Căn villa riêng biệt trên đồi, dành cho nhóm 15–20 người, mở ra tầm nhìn bao quát toàn bộ thung lũng từ trên cao. Từ đây, mặt hồ, đồi núi và những khoảng xanh như được gói trọn trong tầm mắt — đủ riêng tư để tận hưởng một khoảng trời của riêng mình, đủ rộng để cả nhóm cùng quây quần và tạo nên những phút giây đáng nhớ.",
    image: lakaImages.stays.villaTopHill.cover,
    gallery: [...lakaImages.stays.villaTopHill.gallery],
    maxGuests: 20,
    baseGuests: 15,
    bedrooms: 1,
    beds: 5,
...
function unit(
  ...
  return {
    ...
    characterEn:
      "The specific unit is confirmed by LAKA according to availability and group needs.",
  };
}

export const stayUnits: StayUnit[] = [
  unit("001", "stay-guest-house", "zone-lake", "001", "Guest House", "Guest House"),
  ...["006", "007", "008", "009", "010", "011"].map((code) =>
    unit(
      code,
      "stay-forest-lake-suite",
      "zone-lake",
      code,
      "Forest Lake Suite",
      "Forest Lake Suite",
  ...
  ...["004", "005"].map((code) =>
    unit(code, "stay-lake-suite", "zone-lake", code, "Lake Suite", "Lake Suite"),
  ),
  ...["002", "003"].map((code) =>
    unit(code, "stay-bungalow", "zone-forest", code, "Bungalow", "Bungalow"),
  ),
  ...["012", "013"].map((code) =>
    unit(code, "stay-cabin-group", "zone-forest", code, "Cabin Group", "Cabin Group"),
  ),
  ...["018", "019"].map((code) =>
    unit(
      code,
      "stay-forest-lake-suite-2",
      "zone-forest",
      code,
      "Lake Suite Giữa Rừng",
      "Forest Lake Suite",
    ),
  ),
