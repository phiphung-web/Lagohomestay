      ...
      <div className="flex flex-col items-center md:col-span-2 md:items-start lg:col-span-1">
        ...
        <div className="mt-5 flex justify-center md:justify-start">
          <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-3 md:flex-nowrap md:justify-start" aria-label="Các kênh liên hệ">
            <a href="https://facebook.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Facebook LAKA" className="focus-ring grid h-12 w-12 shrink-0 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
            ...
            <a href="https://m.me/lagohomestay" target="_blank" rel="noreferrer" aria-label="Messenger LAKA" className="focus-ring grid h-12 w-12 shrink-0 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
            ...
            <a href="https://instagram.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Instagram LAKA" className="focus-ring grid h-12 w-12 shrink-0 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
            ...
            <a href="https://tiktok.com/@lagohomestay" target="_blank" rel="noreferrer" aria-label="TikTok LAKA" className="focus-ring grid h-12 w-12 shrink-0 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
