    ...
    <div className="container-lago grid gap-10 py-16 text-center md:grid-cols-2 md:text-left xl:grid-cols-[1.2fr_1.3fr_.9fr]">
      ...
      <div>
        ...
        <div className="mt-5 flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:justify-start" aria-label="Các kênh liên hệ">
          <a href="https://facebook.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Facebook LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-full border border-white/30 transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
          ...
          <a href="https://m.me/lagohomestay" target="_blank" rel="noreferrer" aria-label="Messenger LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-full border border-white/30 transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
          ...
          <a href="https://instagram.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Instagram LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-full border border-white/30 transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
            <Instagram className="h-5 w-5" />
          </a>
          <a href={publicContact.zaloHref} target="_blank" rel="noreferrer" aria-label="Zalo LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-full border border-white/30 transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
          ...
          <a href="https://tiktok.com/@lagohomestay" target="_blank" rel="noreferrer" aria-label="TikTok LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-full border border-white/30 transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
          ...
          <a href={publicContact.phoneHref} aria-label="Hotline LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-full border border-white/30 transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
            <Phone className="h-5 w-5" />
          </a>
        </div>
      </div>
    </div>
    <div className="container-lago flex flex-col items-center gap-5 border-t border-white/20 py-8 text-center">
