...
export function Footer() {
  return <footer className="bg-lago-ink text-white">
    <div className="container-lago flex flex-col items-center py-16 text-center">
      <div>
        <Logo inverse />
      </div>

      {/* Thông tin menu - 1 hàng căn giữa */}
      <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-[15px] font-medium text-white/85 sm:gap-x-8">
      ...
      <div className="mt-8 flex flex-col items-center gap-3">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4" aria-label="Các kênh liên hệ">
          <a href="https://facebook.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Facebook LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
          ...
          <a href="https://m.me/lagohomestay" target="_blank" rel="noreferrer" aria-label="Messenger LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
          ...
          <a href="https://instagram.com/lagohomestay" target="_blank" rel="noreferrer" aria-label="Instagram LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
            <Instagram className="h-5 w-5" />
          </a>
          <a href={publicContact.zaloHref} target="_blank" rel="noreferrer" aria-label="Zalo LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
          ...
          <a href="https://tiktok.com/@lagohomestay" target="_blank" rel="noreferrer" aria-label="TikTok LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
          ...
          <a href={publicContact.phoneHref} aria-label="Hotline LAKA" className="focus-ring grid h-12 w-12 place-items-center rounded-lg border-2 border-white/45 bg-white/10 text-white shadow-sm transition hover:scale-105 hover:border-lago-clay hover:bg-lago-clay hover:text-white">
