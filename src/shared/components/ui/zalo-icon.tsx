  ...
  return (
    ...
    >
      <mask id={maskId} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
        ...
        <path d={zaloWordmarkPath} fill="black" transform="translate(3.36 3.5) scale(.72)" />
      </mask>
      <path
        d="M12 2.5C6.75 2.5 2.5 6.3 2.5 11c0 2.7 1.43 5.1 3.65 6.6L5.3 21.5l4.2-1.4c.8.2 1.65.4 2.5.4 5.25 0 9.5-3.8 9.5-8.5S17.25 2.5 12 2.5Z"
        mask={`url(#${maskId})`}
      />
    </svg>
  );
