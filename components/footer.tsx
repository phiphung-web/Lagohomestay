...
export function Footer() {
  return <footer className="bg-lago-ink text-white">
    <div className="container-lago grid gap-12 py-16 md:grid-cols-[1.4fr_.8fr_.8fr]">
      ...
      <div><p className="eyebrow text-white/45">Khám phá</p><div className="mt-5 flex flex-col gap-3 text-sm"><Link href="/luu-tru">Không gian lưu trú</Link><Link href="/trai-nghiem">Trải nghiệm tại Lago</Link><Link href="/thong-tin">Câu hỏi thường gặp</Link><Link href="/chinh-sach">Chính sách lưu trú</Link></div></div>
